        ...
        <label>
          ...
          {props.selectedFiles ? (
            <div className="flex h-full w-full flex-col items-center justify-center rounded-xl border-[2px] border-dashed border-gray-200 py-3 dark:!border-navy-700 lg:pb-0">
              <img src={URL.createObjectURL(props.selectedFiles)} alt="Selected File" className="h-32 w-32 object-contain" />
              <p className="mt-2 text-sm font-medium text-gray-600">{props.selectedFiles.name}</p>
            </div>
          ) : (
            <div className="flex h-full w-full flex-col items-center justify-center rounded-xl border-[2px] border-dashed border-gray-200 py-3 dark:!border-navy-700 lg:pb-0">
